...
- [x] Arsenal Expanded 3130192483
	- [x] Vanilla spears? Modded spears & club on new cheap building? Or lock behind room upgrade the more powerful weaponry?
		- [x] Wooden spear -> metal spear, upgraded version of new vanilla spear
			- [x] Change sprite
	- [x] attack speed removed from vanilla
	- [x] Battle sprites and division sprites
	- [x] Change infographics
		- [x] Dagger
		- [x] Heavy shield
		- [x] Morning star
		- [x] Pike
